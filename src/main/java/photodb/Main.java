 ...
 * png,jpg,gif and bmp - setFormat fixed - snapshot repaint fixed - AWT
 * components removed and now just swing is on - filter by bits per pixel
 * included - snapshot fixed, according to current format - snapshot resizable
 * and refleting straight on a image - adapted and checked for Linux - frame
 * picture included to get a subimage - unnecessary code cleaned initially
 * written by Owen ( Dublin, Ireland ) rewriten by hlino ( São Paulo, Brazil )
 */
...
//    private String dir = "S:\\fotos";
    ...
    //private String defaultFrameSize = "352x288";
     ...
     * @param rgm_alun
     */
    public Main(String frameTitle, int cod_inst, String rgm_alun) {
    ...
    static {
        try {
            ...
            //look and feel from the own system
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Main myWebCam = new Main("JFoto para o aluno ", Integer.parseInt(cod_inst), rgm_alun);
